        ...
        <div className="h-[200px] flex flex-col justify-center relative z-10">
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <div className="w-[40vw] md:w-[30vw] h-[200px] flex items-center justify-center bg-white overflow-hidden absolute top-0 right-0">
              <div className="w-16 h-16 bg-lime-400 blur-[65px] animate-blob-1"></div>
              <div className="w-16 h-16 bg-teal-400 blur-[65px] animate-blob-2"></div>
              <div className="w-16 h-16 bg-cyan-300 blur-[45px] animate-blob-3"></div>
              <div className="w-16 h-16 bg-fuchsia-200 blur-[45px] animate-blob-1"></div>
            </div>
          </div>
        </div>
      </div>
